 ...
 */
export const SAMPLE_KEYS = ["Upload invoice", "Purchases", "Retailers", "Payments", "E-way bills"];
export const LANG_SAMPLES = [
  { code: "en", label: "English", rows: SAMPLE_KEYS },
  { code: "hi", label: "हिंदी", rows: ["इनवॉइस अपलोड करें", "खरीद", "रिटेलर", "भुगतान", "ई-वे बिल"] },
  { code: "pa", label: "ਪੰਜਾਬੀ", rows: ["ਇਨਵੌਇਸ ਅੱਪਲੋਡ ਕਰੋ", "ਖਰੀਦ", "ਰਿਟੇਲਰ", "ਭੁਗਤਾਨ", "ਈ-ਵੇ ਬਿੱਲ"] },
];
